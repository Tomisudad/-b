              ...
              child: Padding(
                ...
                child: Row(children: [
                  Container(
                    width: 56, height: 56,
                    decoration: BoxDecoration(
                      color: AppConfig.cyclingGreen.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: const Icon(Icons.route, color: AppConfig.cyclingGreen, size: 28),
                  ),
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: [
                      ...List.generate(5, (j) => Icon(j < diff ? Icons.star : Icons.star_border, size: 12, color: Colors.amber)),
                      const SizedBox(width: 4),
                      Text(_diffLabel(diff), style: const TextStyle(fontSize: 11, color: AppConfig.textSecondary)),
                    ]),
                    const SizedBox(height: 4),
                    Text('${dist.toStringAsFixed(dist == dist.truncateToDouble() ? 0 : 1)}km · 爬升${climb}m · ${dur}分钟',
                    ...
                    Row(children: [
                      ...
                      const Spacer(),
                      Text('★ $stars', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Colors.amber[700])),
                    ]),
                  ])),
                ]),
              ),
...
target = r'C:\Users\14864\.qclaw\workspace-agent-34339a2d\outdoor_companion\lib\pages\hot_routes_page.dart'
