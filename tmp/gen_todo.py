...
with open(r'C:\Users\14864\.qclaw\workspace-agent-34339a2d\outdoor_companion\lib\pages\my_todo_page.dart', 'w', encoding='utf-8') as f:
    f.write(code)
print('Written:', len(code.encode('utf-8')), 'bytes')
