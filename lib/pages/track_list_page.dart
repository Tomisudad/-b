...
class _TrackListPageState extends State<TrackListPage> {
  ...
  static List<_TrackEntry> _mockTracks() => [
    ...
    _TrackEntry('临安摩托车跑山', OutdoorScenario.cycle, DateTime(2026, 4, 20), 95.0, 210, 1800, 4.2),
    _TrackEntry('德清自驾露营', OutdoorScenario.cycle, DateTime(2026, 4, 15), 120.0, 180, 1200, 6.5),
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 12),
                          Icon(faster ? Icons.arrow_upward : Icons.arrow_downward, size: 14, color: faster ? AppConfig.cyclePrimary : AppConfig.accentOrange),
                          Text(
                            '${s.avgSpeedKmh.toStringAsFixed(1)}km/h',
                            style: TextStyle(fontSize: 13, color: faster ? AppConfig.cyclePrimary : AppConfig.accentOrange),
                          ),
                        ],
                      ),
                    );
