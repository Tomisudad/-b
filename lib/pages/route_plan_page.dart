...
class _RoutePlanPageState extends State<RoutePlanPage> {
  ...
  static List<_RouteEntry> _mockRoutes() => [
    _RouteEntry('G318川藏线自驾', OutdoorScenario.drive, RouteDifficulty.hard, 2100, 10800, 5200),
    _RouteEntry('川西小环线', OutdoorScenario.drive, RouteDifficulty.medium, 320, 1440, 2400),
    _RouteEntry('青海甘肃大环线', OutdoorScenario.drive, RouteDifficulty.hard, 1800, 7200, 6500),
    _RouteEntry('独库公路全程', OutdoorScenario.drive, RouteDifficulty.hard, 561, 3600, 3800),
    _RouteEntry('桂林阳朔山水', OutdoorScenario.drive, RouteDifficulty.easy, 85, 360, 400),
    _RouteEntry('皖南川藏线', OutdoorScenario.moto, RouteDifficulty.medium, 120, 480, 2200),
    _RouteEntry('川西摩旅大环线', OutdoorScenario.moto, RouteDifficulty.hard, 680, 2880, 5200),
    _RouteEntry('太行天路', OutdoorScenario.moto, RouteDifficulty.medium, 95, 360, 1800),
    _RouteEntry('秦岭分水岭', OutdoorScenario.moto, RouteDifficulty.medium, 55, 180, 1500),
